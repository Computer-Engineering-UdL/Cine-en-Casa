    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('UNITED_STATES', 'US'), ('SPAIN', 'ESP'), ('UNITED_KINGDOM', 'UK'), ('JAPAN', 'JAP'), ('KOREA', 'KO'), ('CATALONIA', 'CAT'), ('IRELAND', 'IRE')], max_length=20)),
                ...
                ('current_movie', models.PositiveIntegerField()),
                ('series_type', models.CharField(max_length=4)),
